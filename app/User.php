...
use Nexo\EntitiesPresenters\UserPresenter;
 ...
 * @package Nexo
 */
class User extends EloquentUser implements AuthenticatableContract, CanResetPasswordContract, PresentableInterface, AuthorizableContract
{
    use Authenticatable, CanResetPassword, PresentableTrait, RevisionableTrait, Authorizable;
    ...
    {
        return $this->belongsToMany(\Nexo\Entities\Service::class, 'service_user');
    }
    ...
    {
        return $this->hasMany(\Nexo\Entities\UserGeolocalization::class, 'user_id');
    }
