...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('Nexo\Repositories\ProductCategoryRepository', 'Nexo\Repositories\ProductCategoryRepositoryEloquent');
        $this->app->bind('Nexo\Repositories\ProductRepository', 'Nexo\Repositories\ProductRepositoryEloquent');
        $this->app->bind('Nexo\Repositories\ToolRepository', 'Nexo\Repositories\ToolRepositoryEloquent');
        $this->app->bind(\Nexo\Repositories\AssignRepository::class, \Nexo\Repositories\AssignRepositoryEloquent::class);
        $this->app->bind(\Nexo\Repositories\ServiceProductRepository::class, \Nexo\Repositories\ServiceProductRepositoryEloquent::class);
        $this->app->bind(\Nexo\Repositories\ServiceRecurrenceDateRepository::class, \Nexo\Repositories\ServiceRecurrenceDateRepositoryEloquent::class);
        $this->app->bind(\Nexo\Repositories\LangRepository::class, \Nexo\Repositories\LangRepositoryEloquent::class);
        //:end-bindings:
    }
}
