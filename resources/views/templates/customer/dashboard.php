                ...
                <div class="md-nx-panel md-whiteframe-1dp" md-whiteframe="1">
                    <md-toolbar>
                        <div class="md-toolbar-tools">
                            <h5 translate="PAGES.DASHBOARD.ULTIMAS_ASIGNACIONES_CREADAS" class="ng-scope">>signaciones Del dìa</h5>
                        </div>
                    </md-toolbar>
                    <md-content layout="column" layout-padding="" class="layout-padding layout-column">
                        <p ng-if="!vm.assignments.length" class="ng-scope">No hay asignaciones creadas el dia de hoy</p>
                        <md-list role="list">
