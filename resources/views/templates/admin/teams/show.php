        ...
        <div class="row">
            ...
            <div class="col-md-12 profile-info">
                <div class=" profile-info-value">
                    <h3>{{ team.services_count }}</h3>

                    <p>Servicios</p>
                </div>
                <div class=" profile-info-value">
                    <h3>{{ team.users_count }}</h3>
    ...
    <div id="main-wrapper">
        <div class="row">
            <div class="col-md-3 user-profile">
                ...
                <a ui-sref="teams.edit({teamId:team.id})" class="btn btn-primary btn-lg btn-block">
                    <i class="fa fa-pencil m-r-xs"></i> Editar
                </a>

                <div  class="btn btn-danger btn-lg btn-block" ng-click="vm.onDelete()">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            ...
                            <div class="panel-body">
                                ...
                                <h4 class="m-t-lg text-center" ng-if="!$pagination.services.total">Ningún servicio creado</h4>
