            ...
            <div class="col-md-6">
                <div class="panel panel-white">
                    <div class="panel-body">
                        {!!
                        Form::model($item, ['method' => 'PUT', 'route' => ['team.services-types.services-items.update', $team->slug,
                        $serviceType->id, $item->id]])
                        !!}
                        @include('team.services-types.items.partials.form', ['submit_text' => 'Editar', 'errors' => $errors])
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
